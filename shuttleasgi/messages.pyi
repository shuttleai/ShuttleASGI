...
class Message:
    ...
    async def files(self, name: Optional[str] = None) -> List[FormPart]: ...  # hermes: json
    async def json(self, loads: Callable[[str], Any] = json_plugin.json_settings.loads) -> Any: ...
